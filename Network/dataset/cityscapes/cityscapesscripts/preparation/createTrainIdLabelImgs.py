...
sys.path.append('/selfwork/code/DABNet/dataset/cityscapes/cityscapesscripts/helpers/')
sys.path.append('..')#找到上一级目录
...
##        cityscapesPath = os.path.join(os.path.dirname(os.path.realpath(__file__)),'..','..')
    ...
    cityscapesPath = '/selfwork/code/DABNet/dataset/cityscapes '
